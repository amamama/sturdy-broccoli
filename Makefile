...
test: ./a.out
	...
	diff <(echo -en '200 OK\r\n{"status": "success", "message": "registered", "id": 0}') <(curl POST -H "Content-Type: application/json" -d '{"deadline": "2019-06-11T14:00:00+09:00", "title": "レポート提出", "memo": ""}' http://localhost:8080/api/v1/event)
